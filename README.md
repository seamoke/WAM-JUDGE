...
> a 50-task x 20-episode evaluation of the official post-trained model. Do not
...
> Models, datasets, simulator assets, environments, checkpoints, and experiment
> outputs are intentionally not stored in this repository.
...
# LIBERO (train 4 suites together: spatial/object/goal/libero_10)
# Put all suite folders under one root (each suite keeps its own meta/info.json).
# Example root layout:
# /path/to/libero-mix/
#   libero_spatial/.../meta/info.json
#   libero_object/.../meta/info.json
#   libero_goal/.../meta/info.json
#   libero_10/.../meta/info.json
DATASET_PATH=/path/to/libero-mix NGPU=8 bash script/run_libero_train.sh
```
