...
RUN_ID="${RUN_ID:-robotwin_clean_4xh100_b1_ga32_cosine_2000steps_ckpt400_swanlab_20260724_0230}"
...
# 2,000 optimizer steps expose 256,000 segments, about 106.14 clean epochs.
export LINGBOT_TRAIN_NUM_STEPS=2000
...
export LINGBOT_SAVE_INTERVAL=400
export LINGBOT_SAVE_STEPS=400,800,1200,1600,2000
export LINGBOT_GC_INTERVAL=1000
export LINGBOT_WARMUP_STEPS=200
