...
RUN_ID="${RUN_ID:-robotwin_clean_4xh100_b1_ga32_cosine_50epoch_ckpt10_swanlab_20260724_0101}"
...
# ceil(epoch * 2,412 / (4 GPUs * batch 1 * GA 32)) gives each milestone.
export LINGBOT_TRAIN_NUM_STEPS=943
...
export LINGBOT_SAVE_INTERVAL=943
export LINGBOT_SAVE_STEPS=189,377,566,754,943
export LINGBOT_GC_INTERVAL=1000
export LINGBOT_WARMUP_STEPS=94
